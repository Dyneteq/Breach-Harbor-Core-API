    ...
    const fetchNotifications = async () => {
      try {
        const response = await fetchWithAuth(
          `${config.apiBaseUrl}/collector/notification/get_all?limit=30`
        );
                                ...
                                <tr key={index}>
                                  ...
                                  <td>
                                    <Link
                                      ...
                                      to={`/ip-address/${notification.incident_detail.ip_address_str}`}
                                    >
                                      {
                                        notification.incident_detail
                                          .ip_address_str
                                      }
                                    </Link>
                                  </td>
                                  <td>
                                    <Link
                                      className="text-decoration-none"
                                      to={`/collector/${notification.incident_detail.collector_name}`}
                                    >
                                      {
                                        notification.incident_detail
                                          .collector_name
                                  ...
                                  <td>
                                    <Link
                                      className="text-decoration-none"
                                      to={`/incident/${notification.incident_detail.id}`}
                                    >
